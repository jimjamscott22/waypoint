...
export default function MigrationBanner({ count, error, onImport, onDiscard }) {
  return (
    <div role="status" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 12, background: '#fff8e8', border: '1px solid #efd9a5', borderRadius: radius.card, padding: '12px 16px', color: color.textBodyMid }}>
